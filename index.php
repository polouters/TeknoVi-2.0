        ...
        <div class="container">
            <div class="row">
                <p class="text-center">
                    ...
                    <hr class="primary">
                    <br><br>
                    <p class="text-muted text-center paddingcentro"> Vemos constantemente comercios que, aunque su producto sea compentente y de calidad, cierran por el hecho de no vender lo suficiente. Uno de los motivos principales es la falta de publicidad. Consideramos que la mejor manera de hacerse ver hoy en día es a través de la web, pero los costes de publicitarse en esta herramienta suelen ser altos.Por eso, y dirigido a esos comerciantes, nace TeknoVi, una empresa que crea aplicaciones web de calidad y ajustadas a las necesidades del consumidor actual. <br><br>Si además de las webs para empresas necesitas resolver alguna duda relacionada con la informática o precisas asesoramiento, puedes contar con nuestros servicios.
                    <br><br><br><br>
