        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1 ">
                <ul class="nav navbar-nav navbar-right">
                     <li>
                        <a  class="c-default menu" href="<?php echo url::getRaiz();?>/index.php">Quienes somos?</a>
                    </li>
                    <li>
                        <a class="c-default menu" href="#services">Servicios</a>
                    </li>
                   
                    <li>
                        <a class="c-default menu" href="#contact">Contacto</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
